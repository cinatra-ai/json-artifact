...
const FLOOR_MESSAGES: Record<ContentFloorReason, string> = {
  "malformed-props": "This JSON document cannot be drawn: the view was opened without anything to show.",
  "props-version":
    "This JSON document cannot be drawn: it was handed a snapshot of a version this display does not read.",
  "channel-version":
    "This JSON document cannot be drawn: its content arrived in a form of the content channel this display does not read.",
  "content-unavailable": "This JSON document cannot be drawn here: this view was not given the content to show.",
  "content-absent": "No content is available to show for the revision being viewed.",
  "content-over-cap": "This JSON document is too large to show here. Download it to read the whole of it.",
  ...
  "content-revision-mismatch":
    "This JSON document cannot be drawn: the content handed to this view was read from a different revision than the one being viewed.",
  "invalid-content-projection": "This JSON document cannot be drawn: the content handed to this view is incomplete.",
  "empty-content": "This JSON document is empty.",
};
